...
diabetes <- read.csv("Z:/Doc_UCAIB/cursoR/diabetes.csv")
View(diabetes)
...
plot(diabetes$Glucose, diabetes$Insulin, col = diabetes$Outcome)

diabetes$Outcome <- as.factor(diabetes$Outcome)
ggplot(diabetes) + aes(x = Glucose, y = Insulin, colour = Outcome) + geom_point()
...
ggplot(data = diabetes, aes(x = Glucose, fill = Outcome)) +
    geom_histogram() +
    labs(title = "Distribución de Glucosa según Outcome", 
         x = "Glucosa") +
    theme_dark()
...
ggplot(data = diabetes, aes(x = Outcome, y = Glucose, fill = Outcome)) +
    geom_boxplot() +
    labs(title = "Boxplot de Glucosa por Outcome", x = "Outcome", y = "Glucosa") +
    theme_minimal()



ggplot(data = diabetes, aes(x = Outcome, y = BMI, fill = Outcome)) +
    geom_boxplot() +
    labs(title = "Distribución de IMC por Outcome", x = "Outcome", y = "IMC") +
    theme_minimal()
